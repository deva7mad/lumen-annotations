...
namespace DevA7mad\Annotations\Providers;

use Illuminate\Support\ServiceProvider;
use DevA7mad\Annotations\Metadata\RouteScanner;
use DevA7mad\Annotations\Routing\Generator as RouteGenerator;
use DevA7mad\Annotations\Metadata\EventScanner;
use DevA7mad\Annotations\Events\Generator as EventGenerator;
use DevA7mad\Annotations\Console\RouteScanCommand;
use DevA7mad\Annotations\Console\RouteClearCommand;
use DevA7mad\Annotations\Console\EventScanCommand;
use DevA7mad\Annotations\Console\EventClearCommand;
...
class CommandsServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->register('DevA7mad\Annotations\Providers\MetadataServiceProvider');
    ...
    protected function registerRouteGenerator()
    {
        ...
        $app->singleton('annotations.route.generator', function ($app) {
            $path = config('annotations.routes_output_path');

            return new RouteGenerator($app['files'], $path, 'generated.php');
        });
    }
